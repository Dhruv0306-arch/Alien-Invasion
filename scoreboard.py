...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        self._high_score_image = self.font.render(high_score_str, True, self.text_color, self.settings.bg_colour)

        # Center the high score at the top of the screen
        self.high_score_rect = self._high_score_image.get_rect()
    ...
    def show_score(self):
        ...
        self.screen.blit(self._high_score_image, self.high_score_rect)
